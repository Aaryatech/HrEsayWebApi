...
public class MstCompanySub {
	...
	public String toString() {
		return "MstCompanySub [companyId=" + companyId + ", companyName=" + companyName + ", nameSd=" + nameSd
				+ ", logo=" + logo + ", letterHead=" + letterHead + ", reportHeader=" + reportHeader + ", reportFooter="
				...
				+ ", delStatus=" + delStatus + ", isActive=" + isActive + ", makerEnterDdatetime=" + makerEnterDdatetime
