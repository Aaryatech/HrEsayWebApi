...
public class EmpInfo {
	...
	public String toString() {
		return "EmpInfo [empId=" + empId + ", empCode=" + empCode + ", cmpCode=" + cmpCode + ", empType=" + empType
				+ ", mobileNo1=" + mobileNo1 + ", mobileNo2=" + mobileNo2 + ", residenceLandNo=" + residenceLandNo
				+ ", contractorId=" + contractorId + ", departId=" + departId + ", designationId=" + designationId
				+ ", locationId=" + locationId + ", firstName=" + firstName + ", middleName=" + middleName
				+ ", surname=" + surname + ", motherName=" + motherName + ", societySerialNo=" + societySerialNo
				+ ", panCardNo=" + panCardNo + ", pfNo=" + pfNo + ", esicNo=" + esicNo + ", aadharNo=" + aadharNo
				+ ", uan=" + uan + ", leavingReason=" + leavingReason + ", isEmp=" + isEmp + ", currentShiftid="
				+ currentShiftid + ", nextShiftid=" + nextShiftid + ", grossSalaryEst=" + grossSalaryEst + ", emailId="
				+ emailId + ", noticePayAmount=" + noticePayAmount + ", salDedAtFullandfinal=" + salDedAtFullandfinal
				+ ", addedFrom=" + addedFrom + ", rawData=" + rawData + ", addedBySupervisorId=" + addedBySupervisorId
				+ ", loginName=" + loginName + ", loginTime=" + loginTime + ", plCalcBase=" + plCalcBase
