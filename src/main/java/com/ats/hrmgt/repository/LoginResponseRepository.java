...
public interface LoginResponseRepository extends JpaRepository<LoginResponse, Integer>{
	...
	@Query(value = "SELECT e.emp_id,e.emp_code,e.first_name,e.middle_name,e.surname,e.mother_name,e.email_id,u.loc_id,u.user_id,u.user_pwd from m_employees e, m_user u "
